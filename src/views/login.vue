<template>
  <div class="login" :style="'background-image:url('+ Background +');'">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" label-position="left" label-width="0px" class="login-form">
      <h3 class="title">
        QuestionBank Management System
      </h3>
...
export default {
  ...
  data() {
    return {
      ...
      loginRules: {
        username: [{ required: true, trigger: 'blur', message: 'The user name cannot be empty' }],
        password: [{ required: true, trigger: 'blur', message: 'The password cannot be empty' }],

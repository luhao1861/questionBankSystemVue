      ...
      <el-col :xs="15" :sm="18" :md="19" :lg="20" :xl="20">
        ...
        <el-dialog append-to-body :close-on-click-modal="false" :before-close="crud.cancelCU" :visible.sync="crud.status.cu > 0" :title="crud.status.title" width="570px">
          <el-form ref="form" :inline="true" :model="form" :rules="rules" size="small" label-width="100px">
            ...
            <el-form-item label="Department" prop="dept.id">
              <treeselect
            ...
            <el-form-item label="Position" prop="jobs">
              <el-select
                v-model="jobDatas"
                style="width: 178px"
                multiple
            ...
            <el-form-item style="margin-bottom: 0;" label="Role" prop="roles">
              <el-select
                v-model="roleDatas"
                style="width: 437px"
                multiple
        ...
        <el-table ref="table" v-loading="crud.loading" :data="crud.data" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
          ...
          <el-table-column :show-overflow-tooltip="true" width="135" prop="email" label="E-mail" />
          <el-table-column :show-overflow-tooltip="true" prop="dept" label="Department">
          ...
          <el-table-column :show-overflow-tooltip="true" prop="createTime" width="135" label="Creation date" />
          <el-table-column
...
let userRoles = []
let userJobs = []
const defaultForm = { id: null, username: null, nickName: null, gender: 'Male', email: null, enabled: 'false', roles: [], jobs: [], dept: { id: null }, phone: null }
export default {
  name: 'User',
  components: { Treeselect, crudOperation, rrOperation, udOperation, pagination, DateRangePicker },
  cruds() {
    return CRUD({ title: 'User', url: 'api/users', crudMethod: { ...crudUser }})
  },

  ...
  <div class="app-container">
    ...
    <div class="head-container">
      <div v-if="crud.props.searchToggle">
        <!-- 搜索 -->
        <el-input v-model="query.name" clearable size="small" placeholder="Search by Dept" style="width: 200px;" class="filter-item" @keyup.enter.native="crud.toQuery" />
    ...
    >
      ...
      <el-table-column label="Order" prop="deptSort" />
